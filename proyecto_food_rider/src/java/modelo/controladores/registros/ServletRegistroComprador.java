 ...
 * @author alfon
 */
@WebServlet(name = "ServletRegistroComprador", urlPatterns = {"/ServletRegistroComprador"})
public class ServletRegistroComprador extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        // Hacemos los setters en la entidad Compradores
        compradores.setNumero_documento_comprador(dni);
        compradores.setNss(nss);
        compradores.setNombre(nombre);
        compradores.setApellido_principal(primer_apellido);
        compradores.setApellido_secundario(segundo_apellido);
        compradores.setUsuario(usuarios);

        // Pasamos los valores antes setteados a un registro de la tabla Compradores, con la ayuda de un método del servicio
        servicioCompradores.crearCompradores(compradores);
