...
public class Administradores implements Serializable {
    ...
    @Column(name = "numero_documento_administrador", length = 100, nullable = false)
    private String numero_documento_administrador;
    ...
    public String getNumero_documento_administrador() {
        return numero_documento_administrador;
    }

    public void setNumero_documento_administrador(String numero_documento_administrador) {
        this.numero_documento_administrador = numero_documento_administrador;
    }
